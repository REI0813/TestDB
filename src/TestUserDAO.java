...
public class TestUserDAO {
   ...
   //名前とPWで取得
    public void select(String name, String password) {
        ...
        String sql =
                "select * from test_table where user_name=? and password=?";
    ...
    public void selectByName(String name) {
        ...
        String sql =
                "select * from test_table where user_name=?";
    ...
    public void selectByPassword(String password) {
        ...
        String sql =
                "select * from test_table where password=?";
    ...
    public void updateUserNameByUserName(String oldName, String newName) {
        ...
        String sql =
                "update test_table set user_name=? where user_name=?";
